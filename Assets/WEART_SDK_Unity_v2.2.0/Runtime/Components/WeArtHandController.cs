...
namespace WeArt.Components
{
    ...
    public class WeArtHandController : MonoBehaviour
    {
        ...
        /// <summary>
        /// Defines the hand side
        /// </summary>
        [SerializeField]
        internal HandSide _handSide;
        
        /// <summary>
        /// Defines the hands system component
        /// </summary>
        [SerializeField]
        internal WeArtHandsSystem _handsSystem;
        ...
        /// <summary>
        /// Enable or disable the hand mesh renderer
        /// </summary>
        /// <param name="value">value to force render type</param>
        public void HandleHandVisibility(bool value)
        {
            _handSkinnedMeshRenderer.enabled = value;
            _logoHandPanel.GetComponent<MeshRenderer>().enabled = value;
            if(GetComponentInChildren<WeArtWatchPanel>() != null) GetComponentInChildren<WeArtWatchPanel>().EnableOrDisablePanels(value);
        }

        /// <summary>
        /// Enable or disable the hand mesh renderer
        /// </summary>
        public void HandleHandVisibility()
        {
            bool visible = false;

            if (_handsSystem.HandsRenderType == HandsRenderType.Always_Visible)
                visible = true;
            else if(_handsSystem.HandsRenderType == HandsRenderType.Always_Invisible)
                visible = false;
            else
                visible = _graspingSystem.GraspingState == GraspingState.Grabbed ? false : true;

            _handSkinnedMeshRenderer.enabled = visible;
            _logoHandPanel.GetComponent<MeshRenderer>().enabled = visible;
            if(GetComponentInChildren<WeArtWatchPanel>() != null) GetComponentInChildren<WeArtWatchPanel>().EnableOrDisablePanels(visible);
        }
