...
namespace WeArt.Utils
{
    public class WeArtStatusDisplay : MonoBehaviour
    {
        ...
        private void UpdateDisplayWithWeartAppData()
        {
            ...
            if (_currentWeartAppStatus.WarningDesc != "")
            {
                MiddlewareStatusCodeText.text = "[" + _currentWeartAppStatus.WarningCode + "] ";
                MiddlewareStatusCodeText.color = Color.yellow;

                ErrorDescriptionText.text = "[" + _currentWeartAppStatus.WarningCode + "] " + _currentWeartAppStatus.WarningDesc;
                ErrorDescriptionText.color = Color.yellow;
            }
            
            if (_currentWeartAppStatus.StatusCode == 0)
            {
                MiddlewareStatusCodeText.text = "OK";
                MiddlewareStatusCodeText.color = Color.green;

                ErrorDescriptionText.text = "-"; 
                ErrorDescriptionText.color = Color.green;
            }
            else
            {
                MiddlewareStatusCodeText.text = "[" + _currentWeartAppStatus.StatusCode + "] ";
                MiddlewareStatusCodeText.color = Color.red;

                ErrorDescriptionText.text = "[" + _currentWeartAppStatus.StatusCode + "] " + _currentWeartAppStatus.ErrorDesc;
                ErrorDescriptionText.color = Color.red;
            }
