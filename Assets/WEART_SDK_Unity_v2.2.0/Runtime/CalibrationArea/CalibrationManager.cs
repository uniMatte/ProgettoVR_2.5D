...
public class CalibrationManager : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        weArtController = FindFirstObjectByType<WeArtController>();
#else
...
#if UNITY_6000_0_OR_NEWER
        WeArtHandController[] deviceTrackingObjects = FindObjectsByType<WeArtHandController>(FindObjectsSortMode.None);
    ...
    public void HandleCalibrationAreaVisibility(bool value) { 
        handCalibrationRoot.gameObject.SetActive(value);
    }
    ...
    void CalibrateStartRight(Collider other)
    {
        ...
        {
            weArtController.StartDeviceAndCalibration();
    ...
    {
        Debug.Log("WEARTLog - Calibration Completed");
