...
namespace WeArt.Core
{
    ...
    /// <summary>
    /// The rendering mode of the hand model
    /// </summary>
    public enum HandsRenderType { 
        Always_Visible = 0,
        Invisible_During_Grasp = 1,
        Always_Invisible = 2
    }
    ...
    /// <summary>
    /// Quality of hand physics simulation
    /// </summary>
    public enum HandsPhysicsType
    {
        Low = 0,
        High = 1
    }
    ...
    /// <summary>
    /// Status of the current sensors calibration procedure
    /// </summary>
    public enum SensorsCalibrationStatus
    {
        NOT_CALIBRATING = 0,
        CALIBRATING = 1
    };
    ...
    /// <summary>
    /// Result of the current sensors calibration procedure
    /// </summary>
    public enum SensorsCalibrationResult
    {
        SUCCESSFULLY_STARTED = 0,
        FAILED_STARTING = 1,
        SUCCESSFULLY_CALIBRATED = 2,
        FAILED_CALIBRATING = 3
    };
    ...
    public static class WeArtUtility
    {
        ...
        /// <returns></returns>
        public static float GetInitialMaxDistanceForActPoint(
                                                                ActuationPointFlags actuationPoint,
                                                                float touchableObjectStiffness,
                                                                bool isGrasping,
                                                                DeviceGeneration deviceGeneration)
        {
            bool isTD = deviceGeneration == DeviceGeneration.TD;
            float minStiffness = isTD ? WeArtConstants.MaxDistanceForMinStiffness : WeArtConstants.MaxDistanceForMinStiffness_TDPro;
            float maxStiffness = isTD ? WeArtConstants.MaxDistanceForMaxStiffness : WeArtConstants.MaxDistanceForMaxStiffness_TDPro;
            float minStiffnessMiddle = isTD ? WeArtConstants.MaxDistanceForMinStiffnessMiddle : WeArtConstants.MaxDistanceForMinStiffnessMiddle_TDPro;
            float maxStiffnessMiddle = isTD ? WeArtConstants.MaxDistanceForMaxStiffnessMiddle : WeArtConstants.MaxDistanceForMaxStiffnessMiddle_TDPro;
            float minStiffnessThumb = isTD ? WeArtConstants.MaxDistanceForMinStiffnessThumb : WeArtConstants.MaxDistanceForMinStiffnessThumb_TDPro;
            float maxStiffnessThumb = isTD ? WeArtConstants.MaxDistanceForMaxStiffnessThumb : WeArtConstants.MaxDistanceForMaxStiffnessThumb_TDPro;

            switch (actuationPoint)
            {
                case ActuationPointFlags.Thumb:
                    return isGrasping ? LinearForThumb(touchableObjectStiffness) : LinearOtherActPoints(touchableObjectStiffness, minStiffnessThumb, maxStiffnessThumb);

                case ActuationPointFlags.Middle:
                    return isGrasping ? LinearOtherActPoints(touchableObjectStiffness, minStiffnessMiddle, maxStiffnessMiddle)
                                      : LinearOtherActPoints(touchableObjectStiffness, minStiffness, maxStiffness);

                default:
                    return LinearOtherActPoints(touchableObjectStiffness, minStiffness, maxStiffness);
            }
        }
        ...
        /// <returns></returns>
        public static bool EnableRunningPack(byte[] pack, DeviceGeneration _deviceGeneration = DeviceGeneration.TD)
        {
            ...
            if (pack[0] == WeartSdkPRO.WeartSdkConstants.packId_EnableRunning)
                return true;
            return false;
        }

        /// <summary>
        /// Function to evaluate if RunEnable is ON or OFF for TD
        /// </summary>
        /// <param name="pack"></param>
        /// <returns></returns>
    ...
    public static class WeArtConstants
    {
        ...
        public const string WEART_SDK_VERSION = "2.2.0";
        ...
        public static float MaxDistanceForMinStiffness_TDPro = 0.01f; // 1cm
        public static float MaxDistanceForMaxStiffness_TDPro = 0.005f; // 0.5cm

        public static float MaxDistanceForMinStiffnessMiddle_TDPro = 0.015f; // 1.5cm
        public static float MaxDistanceForMaxStiffnessMiddle_TDPro = 0.0075f; // 0.75cm

        public static float MaxDistanceForMinStiffnessThumb_TDPro = 0.008f; // 0.8cm
        public static float MaxDistanceForMaxStiffnessThumb_TDPro = 0.003f; // 0.3cm
