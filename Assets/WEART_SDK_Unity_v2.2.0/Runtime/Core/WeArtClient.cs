...
using static WEARTPRO.WeartLogger;
...
namespace WeArt.Core 
{
    ...
    public class WeArtClientBLE : WeArtClient
    {
        public override void Start()
        {
            try
            {
                ...
                else
                {
                    ...
                    {
                        _weartCommunicationTDPro.MessageReceivedFromWeartApp -= OnReceivedMessages;
                        _weartCommunicationTDPro.MessageReceivedFromWeartApp += OnReceivedMessages;
                    }
                }
            ...
            WEART.WeartLogger.LogInfoReady += LogFromMiddleware;

            WEARTPRO.WeartLogger.LogInfoReady += LogFromWeartApp;
        }
        ...
        /// <summary>
        /// Sends a message to the Middleware or Weart App DLLs
        /// </summary>
        /// <param name="message">The message</param>
        public override void SendMessage(IWeArtMessage message)
        {
            try
            {
                ...
                else if (WeArtController.Instance.DeviceGeneration == DeviceGeneration.TD_Pro)
                {
                    if (_weartCommunicationTDPro != null)
                    {
                        _weartCommunicationTDPro.SendFromSDKToWeartApp(bytes);
                    }
                }
                OnMessageHandler(MessageType.MessageSent, message);
        ...
        private static void LogFromMiddleware(WeartLogger.LogInformation logInformation)
        {
        ...
        /// <summary>
        /// Event from Weart App DLL for logging
        /// </summary>
        /// <param name="logInformation"></param>
        private static void LogFromWeartApp(WEARTPRO.WeartLogger.LogInformation logInformation)
        {
            WeArtLog.LogFile((LogLevel)logInformation.LogLevel, (PackTag)logInformation.PackTag, logInformation.Content, (DeviceID)logInformation.DeviceID, (PackDescription)logInformation.PackDescription);
        }
