...
#if UNITY_6000_0_OR_NEWER
            _weArtHapticObjects = FindObjectsByType<WeArtHapticObject>(FindObjectsInactive.Include, FindObjectsSortMode.None);
#else
...
#if UNITY_6000_0_OR_NEWER
        weArtSpawnPoint = GameObject.FindFirstObjectByType<WeArtSpawnPoint>();
#else
