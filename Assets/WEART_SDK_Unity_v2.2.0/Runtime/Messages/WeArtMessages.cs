...
namespace WeArt.Messages
{
    ...
    /// <summary>
    /// Message received from the middleware containing the current sensors calibration procedure status
    /// </summary>
    [WeArtMiddlewareMessageID("SensorsCalibrationStatus")]
    public class SensorsCalibrationStatus : IWeArtMessage
    {
        private byte _handSide;
        private byte _status;
        ...
        public Core.SensorsCalibrationStatus Status
        {
            get => (Core.SensorsCalibrationStatus)_status;
            set => _status = (byte)value;
        }
    }

    /// <summary>
    /// Message received from the middleware containing the result of the sensors calibration procedure
    /// </summary>
    [WeArtMiddlewareMessageID("SensorsCalibrationResult")]
    public class SensorsCalibrationResult : IWeArtMessage
    {
        private byte _handSide;
        private Core.SensorsCalibrationResult _success;
        ...
        public Core.SensorsCalibrationResult Success
        {
            get => _success;
            set => _success = value;
        }
    ...
    public class TouchDiverProStatusData : ITouchDiverData
    {
        ...
        public float SignalStrength { get; set; } = 0;

        public string SensorsCalibDate { get; set; }
    ...
    public class RawDataTouchDiverPro : WeArtJsonMessage
    {
        [JsonConverter(typeof(EnumConverter<HandSide>))]
        public HandSide HandSide { get; set; }
        public SensorDataG2 Index { get; set; } = new SensorDataG2();
        public SensorDataG2 Middle { get; set; } = new SensorDataG2();
        public SensorDataG2 Thumb { get; set; } = new SensorDataG2();
        public SensorDataG2 Annular { get; set; } = new SensorDataG2();
        public SensorDataG2 Pinky { get; set; } = new SensorDataG2();
        public SensorDataG2 Palm { get; set; } = new SensorDataG2();
