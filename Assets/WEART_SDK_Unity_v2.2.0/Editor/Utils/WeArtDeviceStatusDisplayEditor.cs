...
namespace WeArt.UnityEditor
{
    ...
    public class WeArtDeviceStatusDisplayEditor : WeArtComponentEditor
    {
        public override VisualElement CreateInspectorGUI()
        {
            ...
            {
                var property = serializedObject.FindProperty(nameof(WeArtDeviceStatusDisplay.SensorsCalibDateImage));
                var propertyField = new PropertyField(property)
                {
                    tooltip = "Image used to show an overdue device calibration"
                };
                editor.Add(propertyField);
            }
            ...
            // Signal Strenght
            {
                var header = new Label(" Signal Strenght");
                header.AddToClassList("header");
                editor.Add(header);
            }
            {
                var property = serializedObject.FindProperty(nameof(WeArtDeviceStatusDisplay.SignalStrenghtDisplay));
                var propertyField = new PropertyField(property)
                {
                    tooltip = "Panel of the hand's BLE signal strenght"
                };
                editor.Add(propertyField);
            }
