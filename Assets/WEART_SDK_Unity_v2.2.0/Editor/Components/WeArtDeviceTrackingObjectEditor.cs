        ...
        public Dictionary<string, (Vector3, Vector3)> _offsetPresets = new Dictionary<string, (Vector3, Vector3)>()
        {
           { "Custom", (
            ...
            { "TD/HTC/XR Elite Controller/Left", (
             ...
             { "TD/HTC/Index Controller/Right", (
                new Vector3(0.05f, -0.055f, -0.0f),
                new Vector3(114.7f, -148.0f, -59.6f)
            )},
            { "TD/HTC/Index Controller/Left", (
                new Vector3(-0.05f, 0.055f, -0.01f),
                new Vector3(67.4f, 0.31f, -74.5f)
            )},
            ...
            { "TDPro/HTC/XR Elite Controller/Right", (
                new Vector3(0.05f, -0.055f, -0.0f),
                new Vector3(114.7f, -148.0f, -59.6f)
            )},
            { "TDPro/HTC/XR Elite Controller/Left", (
                new Vector3(-0.05f, 0.055f, -0.01f),
                new Vector3(67.4f, 0.31f, -74.5f)
            )},
             { "TDPro/HTC/Index Controller/Right", (
                new Vector3(0.05f, -0.055f, -0.0f),
                new Vector3(114.7f, -148.0f, -59.6f)
            )},
            { "TDPro/HTC/Index Controller/Left", (
                new Vector3(-0.05f, 0.055f, -0.01f),
                new Vector3(67.4f, 0.31f, -74.5f)
            )},
            { "TDPro/Meta Quest/OpenXR/Right", (
                new Vector3(0.01f, -0.10f,-0.01f),
                new Vector3(100.60f, 69.0f, 135f)
            )},
            { "TDPro/Meta Quest/OpenXR/Left", (
                new Vector3(-0.04f,-0.08f, -0.04f),
                new Vector3(105.10f, -31.9f, -100.60f)
            )},
            { "TDPro/Meta Quest/XRI/Right", (
                new Vector3(0.0572f, -0.04f, 0f),
                new Vector3(29.7f, -11f, 44.3f)
            )},
            { "TDPro/Meta Quest/XRI/Left", (
                new Vector3(-0.07f,-0.08f, -0.01f),
                new Vector3(44f, -6.3f, -68.5f)
            )},
            { "TDPro/Meta Quest/OculusXR/Right", (
                new Vector3(0.08f,-0.1f, 0.01f),
                new Vector3(165.7f, 173f, -117.7f)
            )},
            { "TDPro/Meta Quest/OculusXR/Left", (
                new Vector3(-0.03412648f, -0.05230969f, 0.01283844f),
                new Vector3(18.463f, 5.344f, -56.111f)
            )},
            { "TDPro/PicoXR/Right", (
                new Vector3(0.04f, -0.08f, -0.02f),
                new Vector3(100.1f, 191.5f, -89.0f)
